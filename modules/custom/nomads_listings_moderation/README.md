# Nomads Listings Moderation

## Purpose
`nomads_listings_moderation` provides a custom taxonomy-reference moderation widget UI for listing-related tag fields, including grouped pill-style controls and force/block toggles.

## What It Does
- Provides field widget plugin `nomads_listings_moderation` for `entity_reference` fields.
...
## Files
- `nomads_listings_moderation.module`
...
- `nomads_listings_moderation.libraries.yml`
