...
namespace Drupal\nomads_moderation\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'nomads_moderation' widget.
 */
#[FieldWidget(
  id: 'nomads_moderation',
  label: new TranslatableMarkup('Nomads moderation buttons'),
...
class ListingsModerationWidget extends OptionsButtonsWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['#attached']['library'][] = 'nomads_moderation/listings_moderation_widget';
