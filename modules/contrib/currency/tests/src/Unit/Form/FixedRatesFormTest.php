...
namespace Drupal\Tests\currency\Unit\Form {
  ...
  /**
   * Tests the fixed rates form for currency exchange rates.
   *
  ...
  class FixedRatesFormTest extends UnitTestCase {
    ...
    public function testBuildForm($rate_rate) {
      ...
      $expected_build['currency_code_from'] = [
      ...
      $expected_build['currency_code_to'] = [
      ...
      $expected_build['rate'] = [
        '#limit_currency_codes' => [$currency_code_to],
        '#default_value' => [
          'amount' => $rate_rate,
      ...
      $expected_build['actions'] = [
        '#type' => 'actions',
      ];
      $expected_build['actions']['save'] = [
        '#button_type' => 'primary',
        '#name' => 'save',
        '#type' => 'submit',
      ];
      ...
      if (!is_null($rate_rate)) {
        $expected_build['actions']['delete'] = [
          '#button_type' => 'danger',
          '#limit_validation_errors' => [['currency_code_from'], ['currency_code_to']],
          '#name' => 'delete',
          '#type' => 'submit',
        ];
     ...
     */
    public static function providerTestBuildForm() {
      return [
        [NULL],
        [mt_rand()],
      ];
    ...
    public function testSubmitFormWithSave() {
      ...
      $exchange_rate_provider = $this->createMock(FixedRates::class);
