...
class CurrencyTest extends UnitTestCase {
  ...
  public function testGetRoundingStep() {
    ...
    $this->assertEquals($rounding_step, $this->sut->getRoundingStep());
  }
  ...
  public function testGetRoundingStepUnavailable() {
    $this->sut->setSubunits(0);
    $this->assertEquals(1.0, $this->sut->getRoundingStep());
  }
   ...
   */
  public function testFormatAmount($expected, $amount, $amount_with_currency_precision_applied) {
   ...
   */
  public static function providerTestFormatAmount() {
    return [
