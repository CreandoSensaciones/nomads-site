...
/**
 * Tests the currency access control handler.
 *
...
class CurrencyAccessControlHandlerTest extends UnitTestCase {
   ...
   */
  public function testCheckAccess($expected_value, $operation, $has_permission, $permission, $entity_status = FALSE, $currency_code = NULL) {
  ...
  public static function providerTestCheckAccess() {
    return [
      ...
      [FALSE, 'delete', TRUE, 'currency.currency.delete', TRUE, 'XXX'],
      // A disabled currency cannot be disabled.
      [FALSE, 'disable', TRUE, 'currency.currency.update', FALSE],
      // An enabled currency cannot be enabled.
      [FALSE, 'enable', TRUE, 'currency.currency.update', TRUE],
      // A disabled currency cannot be enabled without permission.
      [FALSE, 'disable', FALSE, 'currency.currency.update', TRUE],
      // A disabled currency cannot be enabled without permission.
      [FALSE, 'enable', FALSE, 'currency.currency.update', FALSE],
      // A disabled currency can be enabled.
      [TRUE, 'disable', TRUE, 'currency.currency.update', TRUE],
      // A disabled currency can be enabled.
      [TRUE, 'enable', TRUE, 'currency.currency.update', FALSE],
      // A currency cannot be updated without permission.
      [FALSE, 'update', FALSE, 'currency.currency.update'],
      // A currency can be updated with permission.
      [TRUE, 'update', TRUE, 'currency.currency.update'],
      // A currency cannot be deleted without permission.
      [FALSE, 'delete', FALSE, 'currency.currency.delete'],
      // A currency can be deleted with permission.
      [TRUE, 'delete', TRUE, 'currency.currency.delete'],
    ];
  }
