  ...
  class CurrencyFormTest extends UnitTestCase {
    ...
    public function testCreate() {
      ...
      $map = [
        ...
        ['currency.input', ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $this->inputParser],
    ...
    public function testCopyFormValuesToEntity() {
      ...
      $method->invokeArgs($this->sut, [$this->currency, $form, $form_state]);
    }
    ...
    public function testForm() {
      ...
      $expected['currency_code'] = [
        ...
        '#disabled' => TRUE,
        '#element_validate' => [[$this->sut, 'validateCurrencyCode']],
        '#maxlength' => 3,
        '#pattern' => '[a-zA-Z]{3}',
        '#placeholder' => 'XXX',
        '#required' => TRUE,
      ...
      $expected['currency_number'] = [
        ...
        '#element_validate' => [[$this->sut, 'validateCurrencyNumber']],
        '#maxlength' => 3,
        '#pattern' => '[\d]{3}',
        '#placeholder' => '999',
        '#size' => 3,
      ...
      $expected['rounding_step'] = [
        ...
        '#element_validate' => [[$this->sut, 'validateRoundingStep']],
        '#required' => TRUE,
        '#type' => 'textfield',
      ];
     ...
     */
    public static function providerTestValidateCurrencyCode() {
      return [
     ...
     */
    public static function providerTestValidateCurrencyNumber() {
      return [
        // All valid values and no re-use of the currency code.
        [TRUE, '123', TRUE],
        // An invalid currency code.
     ...
     */
    public static function providerTestValidateRoundingStep() {
      return [
        [TRUE, '0.05', 0.05],
        [FALSE, '0.0g', FALSE],
      ];
