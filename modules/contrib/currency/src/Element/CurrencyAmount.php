 ...
 */
class CurrencyAmount extends FormElementBase implements ContainerFactoryPluginInterface {
   ...
   *   The storage handler for currency entities.
   * @param \Commercie\Currency\InputInterface $input
   *   The input parser for currency values.
   * @param \Drupal\currency\FormHelperInterface $form_helper
   *   A helper service for managing currency-related forms.
   */
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    return new static(
      ...
      // @todo Do not inject entity storage directly, instead inject the entity
      //   type manager and get the storage from there.
      $entity_type_manager->getStorage('currency'),
      $container->get('currency.input'),
  ...
  public function getInfo() {
    ...
    return [
      ...
      // The ISO 4217 codes of the currencies the amount must be in. Use an
      // empty array to allow any currency.
  ...
  public function elementValidate($element, FormStateInterface $form_state, array $form) {
    ...
    // after running it through InputInterface::parseAmount().
