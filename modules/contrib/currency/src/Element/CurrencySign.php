 ...
 */
class CurrencySign extends FormElementBase implements ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    return new static(
      ...
      // @todo Do not inject the storage directly, instead inject the entity
      //   type manager.
  ...
  public function process(array $element, FormStateInterface $form_state, array $form) {
    ...
    $signs = array_merge([$currency->getSign()], $currency->getAlternativeSigns());
    $signs = array_combine($signs, $signs);
    $signs = array_unique(array_filter(array_merge([
