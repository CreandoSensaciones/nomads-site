  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    switch ($triggering_element['#name']) {
      case 'save':
        ...
        $this->messenger()->addMessage($this->t('The exchange rate for @currency_title_from to @currency_title_to has been saved.', [
      ...
      case 'delete':
        ...
        $this->messenger()->addMessage($this->t('The exchange rate for @currency_title_from to @currency_title_to has been deleted.', [
          '@currency_title_from' => $currency_from->label(),
          '@currency_title_to' => $currency_to->label(),
        ]));
        break;
