...
class DomainElementManager implements DomainElementManagerInterface {
  ...
  /**
   * The entity_autocomplete selector plugin manager.
   *
   * @var \Drupal\Core\Entity\EntityReferenceSelection\SelectionPluginManagerInterface
   */
  protected $selectPluginManager;
   ...
   *   The autocomplete selection plugin manager.
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, RendererInterface $renderer, SelectionPluginManagerInterface $selection_plugin_manager) {
    $this->entityTypeManager = $entity_type_manager;
    $this->domainStorage = $entity_type_manager->getStorage('domain');
    $this->renderer = $renderer;
    $this->selectPluginManager = $selection_plugin_manager;
  }
